...
public final class I386CountLeadingZerosNode extends UnaryNode implements ArithmeticLIRLowerable {
    public static final NodeClass<I386CountLeadingZerosNode> TYPE = NodeClass.create(I386CountLeadingZerosNode.class);

    public I386CountLeadingZerosNode(ValueNode value) {
    ...
    public void generate(NodeLIRBuilderTool builder, ArithmeticLIRGeneratorTool gen) {
        builder.setResult(this, ((I386ArithmeticLIRGeneratorTool) gen).emitCountLeadingZeros(builder.operand(getValue())));
    }
}
