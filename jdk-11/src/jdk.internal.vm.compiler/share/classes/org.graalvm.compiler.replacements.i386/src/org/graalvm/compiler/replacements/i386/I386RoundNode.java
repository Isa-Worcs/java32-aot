...
public final class I386RoundNode extends UnaryNode implements ArithmeticLIRLowerable {
    public static final NodeClass<I386RoundNode> TYPE = NodeClass.create(I386RoundNode.class);

    private final RoundingMode mode;

    public I386RoundNode(ValueNode value, RoundingMode mode) {
    ...
    public void generate(NodeLIRBuilderTool builder, ArithmeticLIRGeneratorTool gen) {
        builder.setResult(this, ((I386ArithmeticLIRGeneratorTool) gen).emitRound(builder.operand(getValue()), mode));
    }
}
