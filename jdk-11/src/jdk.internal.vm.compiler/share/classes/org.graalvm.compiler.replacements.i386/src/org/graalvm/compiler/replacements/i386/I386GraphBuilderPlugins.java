...
import org.graalvm.compiler.lir.i386.I386ArithmeticLIRGeneratorTool.RoundingMode;
...
public class I386GraphBuilderPlugins {

    public static void register(Plugins plugins, BytecodeProvider replacementsBytecodeProvider, I386 arch, boolean arithmeticStubs) {
    ...
    private static void registerIntegerLongPlugins(InvocationPlugins plugins, Class<?> substituteDeclaringClass, JavaKind kind, I386 arch, BytecodeProvider bytecodeProvider) {
        Class<?> declaringClass = kind.toBoxedJavaClass();
        Class<?> type = kind.toJavaClass();
        Registration r = new Registration(plugins, declaringClass, bytecodeProvider);
        if (arch.getFeatures().contains(I386.CPUFeature.LZCNT) && arch.getFlags().contains(I386.Flag.UseCountLeadingZerosInstruction)) {
            r.register1("numberOfLeadingZeros", type, new InvocationPlugin() {
                @Override
                public boolean apply(GraphBuilderContext b, ResolvedJavaMethod targetMethod, Receiver receiver, ValueNode value) {
                    ValueNode folded = I386CountLeadingZerosNode.tryFold(value);
                    if (folded != null) {
                        b.addPush(JavaKind.Int, folded);
                    } else {
                        b.addPush(JavaKind.Int, new I386CountLeadingZerosNode(value));
                    }
                    return true;
                }
            });
        ...
        if (arch.getFeatures().contains(I386.CPUFeature.BMI1) && arch.getFlags().contains(I386.Flag.UseCountTrailingZerosInstruction)) {
            r.register1("numberOfTrailingZeros", type, new InvocationPlugin() {
                @Override
                public boolean apply(GraphBuilderContext b, ResolvedJavaMethod targetMethod, Receiver receiver, ValueNode value) {
                    ValueNode folded = I386CountTrailingZerosNode.tryFold(value);
                    if (folded != null) {
                        b.addPush(JavaKind.Int, folded);
                    } else {
                        b.addPush(JavaKind.Int, new I386CountTrailingZerosNode(value));
                    }
                    return true;
                }
            });
        ...
        if (arch.getFeatures().contains(I386.CPUFeature.POPCNT)) {
    ...
    private static void registerMathPlugins(InvocationPlugins plugins, I386 arch, boolean arithmeticStubs, BytecodeProvider bytecodeProvider) {
        ...
        if (arithmeticStubs) {
            ...
            r.registerMethodSubstitution(I386MathSubstitutions.class, "sin", double.class);
            r.registerMethodSubstitution(I386MathSubstitutions.class, "cos", double.class);
            r.registerMethodSubstitution(I386MathSubstitutions.class, "tan", double.class);
        }
    ...
    private static void registerRound(Registration r, String name, RoundingMode mode) {
        r.register1(name, Double.TYPE, new InvocationPlugin() {
            ...
            public boolean apply(GraphBuilderContext b, ResolvedJavaMethod targetMethod, Receiver receiver, ValueNode arg) {
                b.push(JavaKind.Double, b.append(new I386RoundNode(arg, mode)));
                return true;
            }
        });
    }

    private static void registerStringPlugins(InvocationPlugins plugins, I386 arch, BytecodeProvider replacementsBytecodeProvider) {
        if (Java8OrEarlier) {
            Registration r;
            r = new Registration(plugins, String.class, replacementsBytecodeProvider);
            r.setAllowOverwrite(true);
            if (arch.getFeatures().contains(CPUFeature.SSE4_2)) {
                r.registerMethodSubstitution(I386StringSubstitutions.class, "indexOf", char[].class, int.class,
                                int.class, char[].class, int.class, int.class, int.class);
            }
            r.registerMethodSubstitution(I386StringSubstitutions.class, "compareTo", Receiver.class, String.class);
        }
    }
    ...
    private static void registerStringLatin1Plugins(InvocationPlugins plugins, BytecodeProvider replacementsBytecodeProvider) {
        if (JAVA_SPECIFICATION_VERSION >= 9) {
            ...
            r.setAllowOverwrite(true);
            r.registerMethodSubstitution(I386StringLatin1Substitutions.class, "compareTo", byte[].class, byte[].class);
            r.registerMethodSubstitution(I386StringLatin1Substitutions.class, "compareToUTF16", byte[].class, byte[].class);
        }
    }
    ...
    private static void registerStringUTF16Plugins(InvocationPlugins plugins, BytecodeProvider replacementsBytecodeProvider) {
        if (JAVA_SPECIFICATION_VERSION >= 9) {
            ...
            r.setAllowOverwrite(true);
            r.registerMethodSubstitution(I386StringUTF16Substitutions.class, "compareTo", byte[].class, byte[].class);
            r.registerMethodSubstitution(I386StringUTF16Substitutions.class, "compareToLatin1", byte[].class, byte[].class);
        }
    }
