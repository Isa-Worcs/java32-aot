...
/**
 * Snippets used for conversion operations on I386 where the I386 instruction used does not match
 * the semantics of the JVM specification.
 */
public class I386ConvertSnippets implements Snippets {
    ...
    public static class Templates extends AbstractTemplates {
        ...
        public Templates(OptionValues options, Iterable<DebugHandlersFactory> factories, Providers providers, SnippetReflectionProvider snippetReflection, TargetDescription target) {
            ...
            f2i = snippet(I386ConvertSnippets.class, "f2i");
            f2l = snippet(I386ConvertSnippets.class, "f2l");
            d2i = snippet(I386ConvertSnippets.class, "d2i");
            d2l = snippet(I386ConvertSnippets.class, "d2l");
        }
        ...
        public void lower(FloatConvertNode convert, LoweringTool tool) {
            ...
            args.add("result", graph.unique(new I386FloatConvertNode(convert.getFloatConvert(), convert.getValue())));
