...
public class I386Call {

    public abstract static class CallOp extends I386LIRInstruction {
    ...
    public static class DirectCallOp extends MethodCallOp {
        ...
        public int emitCall(CompilationResultBuilder crb, I386MacroAssembler masm) {
    ...
    public static final class DirectFarForeignCallOp extends ForeignCallOp {
        ...
        public DirectFarForeignCallOp(ForeignCallLinkage callTarget, Value result, Value[] parameters, Value[] temps, LIRFrameState state) {
             ...
             */
            callTemp = I386.rax.asValue(LIRKind.value(I386Kind.QWORD));
    ...
    public static int directCall(CompilationResultBuilder crb, I386MacroAssembler masm, InvokeTarget callTarget, Register scratch, boolean align, LIRFrameState info) {
        if (align) {
    ...
    protected static void emitAlignmentForDirectCall(CompilationResultBuilder crb, I386MacroAssembler masm) {
    ...
    public static void directJmp(CompilationResultBuilder crb, I386MacroAssembler masm, InvokeTarget target) {
        int before = masm.position();
        masm.jmp(0, true);
        int after = masm.position();
    ...
    public static void directConditionalJmp(CompilationResultBuilder crb, I386MacroAssembler masm, InvokeTarget target, ConditionFlag cond) {
        int before = masm.position();
    ...
    public static int indirectCall(CompilationResultBuilder crb, I386MacroAssembler masm, Register dst, InvokeTarget callTarget, LIRFrameState info) {
        int before = masm.position();
        masm.call(dst);
        int after = masm.position();
