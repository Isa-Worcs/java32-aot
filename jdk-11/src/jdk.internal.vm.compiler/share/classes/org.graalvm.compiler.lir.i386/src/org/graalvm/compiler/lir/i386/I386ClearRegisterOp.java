...
public class I386ClearRegisterOp extends I386LIRInstruction {
    public static final LIRInstructionClass<I386ClearRegisterOp> TYPE = LIRInstructionClass.create(I386ClearRegisterOp.class);

    @Opcode private final I386RMOp op;
    private final OperandSize size;

    @Def({REG}) protected AllocatableValue result;

    public I386ClearRegisterOp(OperandSize size, AllocatableValue result) {
        super(TYPE);
