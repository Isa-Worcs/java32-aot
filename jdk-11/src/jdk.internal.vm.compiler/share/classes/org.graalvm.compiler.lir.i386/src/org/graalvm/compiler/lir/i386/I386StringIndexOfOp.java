...
/**
  */
@Opcode("I386_STRING_INDEX_OF")
public final class I386StringIndexOfOp extends I386LIRInstruction {
    public static final LIRInstructionClass<I386StringIndexOfOp> TYPE = LIRInstructionClass.create(I386StringIndexOfOp.class);
    ...
    public I386StringIndexOfOp(LIRGeneratorTool tool, Value result, Value charPtr1, Value charPtr2, RegisterValue cnt1, RegisterValue cnt2, RegisterValue temp1, RegisterValue vectorTemp1,
                    int intCnt2, int vmPageSize) {
        super(TYPE);
        assert ((I386) tool.target().arch).getFeatures().contains(CPUFeature.SSE4_2);
        resultValue = result;
