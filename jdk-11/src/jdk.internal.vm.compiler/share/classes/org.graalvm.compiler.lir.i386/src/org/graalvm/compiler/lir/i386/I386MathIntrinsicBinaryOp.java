...
public final class I386MathIntrinsicBinaryOp extends I386LIRInstruction {
    public static final LIRInstructionClass<I386MathIntrinsicBinaryOp> TYPE = LIRInstructionClass.create(I386MathIntrinsicBinaryOp.class);
    ...
    public I386MathIntrinsicBinaryOp(LIRGeneratorTool tool, BinaryIntrinsicOpcode opcode, Value result, Value input, Value alternateInput) {
        super(TYPE);
        this.opcode = opcode;
        this.result = result;
        this.input = input;
    ...
    public void emitCode(CompilationResultBuilder crb, I386MacroAssembler masm) {
        switch (opcode) {
            case POW:
                powIntrinsic(asRegister(result, I386Kind.DOUBLE), asRegister(input, I386Kind.DOUBLE), asRegister(secondInput, I386Kind.DOUBLE), crb, masm);
                break;
            default:
    ...
    public void powIntrinsic(Register dest, Register value1, Register value2, CompilationResultBuilder crb, I386MacroAssembler masm) {
        ...
        masm.movdqu(temp1, new I386Address(gpr8, 0));       // 0x6dc96112,
                                                             // 0xbf836578,
                                                             // 0xee241472,
                                                             // 0xbf9b0301
        masm.movdqu(temp4, new I386Address(gpr8, 16));      // 0x9f95985a,
                                                             // 0xbfb528db,
                                                             // 0xb3841d2a,
                                                             // 0xbfd619b6
        masm.movdqu(temp6, new I386Address(gpr8, 32));      // 0x518775e3,
                                                             // 0x3f9004f2,
                                                             // 0xac8349bb,
                                                             // 0x3fa76c9b
        masm.movdqu(dest, new I386Address(gpr8, 48));       // 0x486ececc,
                                                             // 0x3fc4635e,
                                                             // 0x161bb241,
                                                             // 0xbf5dabe1
        ...
        masm.shrl(gpr4, 10);
        masm.addpd(temp5, new I386Address(gpr7, gpr4, Scale.Times1, -3648));
        ...
        masm.andl(gpr4, 255);
        masm.addl(gpr4, gpr4);
        masm.movdqu(temp5, new I386Address(gpr7, gpr4, Scale.Times8, 0));
        ...
        masm.movdqu(temp7, new I386Address(gpr8, 0));       // 0xe78a6731,
                                                             // 0x3f55d87f,
                                                             // 0xd704a0c0,
                                                             // 0x3fac6b08
        masm.movdqu(temp3, new I386Address(gpr8, 16));      // 0x6fba4e77,
                                                             // 0x3f83b2ab,
                                                             // 0xff82c58f,
                                                             // 0x3fcebfbd
        masm.shll(gpr3, 12);
        ...
        masm.andl(gpr1, 255);
        masm.addl(gpr1, gpr1);
        masm.movdqu(temp5, new I386Address(gpr7, gpr1, Scale.Times8, 0));
        ...
        masm.movq(temp1, new I386Address(gpr8, 32));        // 0xfefa39ef,
                                                             // 0x3fe62e42
        ...
        masm.leaq(gpr7, externalAddress(logTwoPowPtr));      // 0xfefa39ef,
                                                             ...
                                                             // 0xfefa39ef,
                                                             // 0xbfe62e42
        masm.movq(temp4, new I386Address(gpr7, gpr5, Scale.Times8, 0));
        ...
        masm.movdqu(temp4, new I386Address(gpr8, 0));         // 0x00000000,
                                                               // 0xbfd61a00,
                                                               // 0x00000000,
                                                               // 0xbf5dabe1
        masm.pand(dest, temp6);
        ...
        masm.andl(gpr4, 16760832);
        masm.shrl(gpr4, 10);
        masm.addpd(temp7, new I386Address(gpr7, gpr4, Scale.Times1, -3648));
        ...
        masm.leaq(gpr8, externalAddress(coeffPowPtr));
        masm.movdqu(dest, new I386Address(gpr8, 0));        // 0x6dc96112,
                                                             // 0xbf836578,
                                                             // 0xee241472,
                                                             // 0xbf9b0301
        ...
        masm.movdqu(temp2, new I386Address(gpr8, 64));      // 0x486ececc,
                                                             // 0x3fc4635e,
                                                             // 0x161bb241,
                                                             // 0xbf5dabe1
        ...
        masm.movdqu(temp5, new I386Address(gpr8, 80));      // 0x9f95985a,
                                                             // 0xbfb528db,
                                                             // 0xf8b5787d,
                                                             // 0x3ef2531e
        masm.pshufd(temp3, temp3, 0x44);
        ...
        masm.movdqu(temp1, new I386Address(gpr8, 32));      // 0x9f95985a,
                                                             // 0xbfb528db,
                                                             // 0xb3841d2a,
                                                             // 0xbfd619b6
        masm.mulpd(dest, temp3);
        ...
        masm.movq(temp4, new I386Address(gpr8, 8));         // 0x00000000,
                                                             // 0xffffffff
        ...
        masm.movdqu(temp3, new I386Address(gpr8, 16));      // 0x6fba4e77,
                                                             ...
                                                             // 0xff82c58f,
                                                             // 0x3fcebfbd
        masm.movq(temp2, new I386Address(gpr8, 32));        // 0xfefa39ef,
                                                             // 0x3fe62e42
        masm.subsd(temp4, temp6);
        masm.addsd(temp4, temp1);
        masm.pextrw(gpr4, temp6, 3);
