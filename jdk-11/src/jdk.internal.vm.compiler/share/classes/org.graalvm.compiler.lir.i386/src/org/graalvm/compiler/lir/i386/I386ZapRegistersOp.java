...
import static org.graalvm.compiler.lir.i386.I386SaveRegistersOp.prune;
 ...
 */
@Opcode("ZAP_REGISTER")
public final class I386ZapRegistersOp extends I386LIRInstruction implements SaveRegistersOp {
    public static final LIRInstructionClass<I386ZapRegistersOp> TYPE = LIRInstructionClass.create(I386ZapRegistersOp.class);
    ...
    public I386ZapRegistersOp(Register[] zappedRegisters, JavaConstant[] zapValues) {
        super(TYPE);
    ...
    public void emitCode(CompilationResultBuilder crb, I386MacroAssembler masm) {
        for (int i = 0; i < zappedRegisters.length; i++) {
            ...
            if (reg != null) {
                I386Move.const2reg(crb, masm, reg, zapValues[i]);
            }
        }
    }
