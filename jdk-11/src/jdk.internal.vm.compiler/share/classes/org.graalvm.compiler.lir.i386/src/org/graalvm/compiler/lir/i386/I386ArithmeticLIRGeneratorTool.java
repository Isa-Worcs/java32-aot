...
/**
 * This interface can be used to generate I386 LIR for arithmetic operations.
 */
public interface I386ArithmeticLIRGeneratorTool extends ArithmeticLIRGeneratorTool {
    ...
    void emitCompareOp(I386Kind cmpKind, Variable left, Value right);
}
