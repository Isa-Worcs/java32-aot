...
public class I386SaveRegistersOp extends I386LIRInstruction implements SaveRegistersOp {
    public static final LIRInstructionClass<I386SaveRegistersOp> TYPE = LIRInstructionClass.create(I386SaveRegistersOp.class);
     ...
     */
    public I386SaveRegistersOp(Register[] savedRegisters, AllocatableValue[] savedRegisterLocations, boolean supportsRemove) {
        this(TYPE, savedRegisters, savedRegisterLocations, supportsRemove);
    }

    public I386SaveRegistersOp(LIRInstructionClass<? extends I386SaveRegistersOp> c, Register[] savedRegisters, AllocatableValue[] savedRegisterLocations, boolean supportsRemove) {
        super(c);
    ...
    protected void saveRegister(CompilationResultBuilder crb, I386MacroAssembler masm, StackSlot result, Register input) {
        I386Move.reg2stack((I386Kind) result.getPlatformKind(), crb, masm, result, input);
    }
