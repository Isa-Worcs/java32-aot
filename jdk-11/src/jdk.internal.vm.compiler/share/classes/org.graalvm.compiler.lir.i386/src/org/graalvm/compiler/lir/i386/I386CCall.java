...
public final class I386CCall extends I386LIRInstruction {
    public static final LIRInstructionClass<I386CCall> TYPE = LIRInstructionClass.create(I386CCall.class);
    ...
    public I386CCall(Value result, Value functionPtr, Value numberOfFloatingPointArguments, Value[] parameters) {
        super(TYPE);
        this.result = result;
    ...
    private void directCall(I386MacroAssembler masm) {
