 ...
 */
@Opcode("BREAKPOINT")
public final class I386BreakpointOp extends I386LIRInstruction {
    public static final LIRInstructionClass<I386BreakpointOp> TYPE = LIRInstructionClass.create(I386BreakpointOp.class);
    ...
    public I386BreakpointOp(Value[] parameters) {
        super(TYPE);
