...
public class I386FrameMapBuilder extends FrameMapBuilderImpl {

    public I386FrameMapBuilder(FrameMap frameMap, CodeCacheProvider codeCache, RegisterConfig registerConfig) {
    ...
    public StackSlot allocateRBPSpillSlot() {
        return ((I386FrameMap) getFrameMap()).allocateRBPSpillSlot();
    }

    public void freeRBPSpillSlot() {
        ((I386FrameMap) getFrameMap()).freeRBPSpillSlot();
    }

    public StackSlot allocateDeoptimizationRescueSlot() {
        return ((I386FrameMap) getFrameMap()).allocateDeoptimizationRescueSlot();
    }
}
