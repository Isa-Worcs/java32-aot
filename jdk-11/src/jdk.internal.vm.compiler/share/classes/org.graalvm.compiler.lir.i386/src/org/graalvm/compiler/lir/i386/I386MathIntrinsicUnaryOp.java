...
public final class I386MathIntrinsicUnaryOp extends I386LIRInstruction {
    public static final LIRInstructionClass<I386MathIntrinsicUnaryOp> TYPE = LIRInstructionClass.create(I386MathIntrinsicUnaryOp.class);
    ...
    public I386MathIntrinsicUnaryOp(LIRGeneratorTool tool, UnaryIntrinsicOpcode opcode, Value result, Value input, Value stackTemp) {
        super(TYPE);
        this.opcode = opcode;
        this.result = result;
        this.input = input;
        if (opcode == UnaryIntrinsicOpcode.LOG || opcode == UnaryIntrinsicOpcode.LOG10 ||
            ...
            this.gpr1Temp = tool.newVariable(LIRKind.value(I386Kind.QWORD));
            this.gpr2Temp = tool.newVariable(LIRKind.value(I386Kind.QWORD));
            this.rcxTemp = I386.rcx.asValue(LIRKind.value(I386Kind.QWORD));
            this.gpr4Temp = tool.newVariable(LIRKind.value(I386Kind.QWORD));
            this.xmm1Temp = tool.newVariable(LIRKind.value(I386Kind.DOUBLE));
            this.xmm2Temp = tool.newVariable(LIRKind.value(I386Kind.DOUBLE));
            this.xmm3Temp = tool.newVariable(LIRKind.value(I386Kind.DOUBLE));
            this.xmm4Temp = tool.newVariable(LIRKind.value(I386Kind.DOUBLE));
            this.xmm5Temp = tool.newVariable(LIRKind.value(I386Kind.DOUBLE));
            this.xmm6Temp = tool.newVariable(LIRKind.value(I386Kind.DOUBLE));
            this.xmm7Temp = tool.newVariable(LIRKind.value(I386Kind.DOUBLE));

            if (opcode == UnaryIntrinsicOpcode.EXP) {
                this.gpr5Temp = tool.newVariable(LIRKind.value(I386Kind.QWORD));
                this.xmm8Temp = tool.newVariable(LIRKind.value(I386Kind.DOUBLE));
                this.xmm9Temp = tool.newVariable(LIRKind.value(I386Kind.DOUBLE));
                this.xmm10Temp = tool.newVariable(LIRKind.value(I386Kind.DOUBLE));
            }

            if (opcode == UnaryIntrinsicOpcode.TAN) {
                this.gpr5Temp = tool.newVariable(LIRKind.value(I386Kind.QWORD));
                this.gpr6Temp = tool.newVariable(LIRKind.value(I386Kind.QWORD));
                this.gpr7Temp = tool.newVariable(LIRKind.value(I386Kind.QWORD));
                this.gpr8Temp = tool.newVariable(LIRKind.value(I386Kind.QWORD));
                this.gpr9Temp = tool.newVariable(LIRKind.value(I386Kind.QWORD));
                this.gpr10Temp = tool.newVariable(LIRKind.value(I386Kind.QWORD));
            }
    ...
    public I386MathIntrinsicUnaryOp(LIRGeneratorTool tool, UnaryIntrinsicOpcode opcode, Value result, Value input) {
    ...
    private I386Address externalAddress(ArrayDataPointerConstant curPtr) {
        return (I386Address) internalCrb.recordDataReferenceInCode(curPtr);
    }
    ...
    public void emitCode(CompilationResultBuilder crb, I386MacroAssembler masm) {
        switch (opcode) {
            case LOG:
                logIntrinsic(asRegister(result, I386Kind.DOUBLE), asRegister(input, I386Kind.DOUBLE), crb, masm);
                break;
            case LOG10:
                log10Intrinsic(asRegister(result, I386Kind.DOUBLE), asRegister(input, I386Kind.DOUBLE), crb, masm);
                break;
            case SIN:
                sinIntrinsic(asRegister(result, I386Kind.DOUBLE), asRegister(input, I386Kind.DOUBLE), crb, masm);
                break;
            case COS:
                cosIntrinsic(asRegister(result, I386Kind.DOUBLE), asRegister(input, I386Kind.DOUBLE), crb, masm);
                break;
            case TAN:
                tanIntrinsic(asRegister(result, I386Kind.DOUBLE), asRegister(input, I386Kind.DOUBLE), crb, masm);
                break;
            case EXP:
                expIntrinsic(asRegister(result, I386Kind.DOUBLE), asRegister(input, I386Kind.DOUBLE), crb, masm);
                break;
            default:
    ...
    public void logIntrinsic(Register dest, Register value, CompilationResultBuilder crb, I386MacroAssembler masm) {
        ...
        Register gpr1 = asRegister(gpr1Temp, I386Kind.QWORD);
        Register gpr2 = asRegister(gpr2Temp, I386Kind.QWORD);
        Register gpr3 = asRegister(rcxTemp, I386Kind.QWORD);
        Register gpr4 = asRegister(gpr4Temp, I386Kind.QWORD);

        Register temp1 = asRegister(xmm1Temp, I386Kind.DOUBLE);
        Register temp2 = asRegister(xmm2Temp, I386Kind.DOUBLE);
        Register temp3 = asRegister(xmm3Temp, I386Kind.DOUBLE);
        Register temp4 = asRegister(xmm4Temp, I386Kind.DOUBLE);
        Register temp5 = asRegister(xmm5Temp, I386Kind.DOUBLE);
        Register temp6 = asRegister(xmm6Temp, I386Kind.DOUBLE);
        Register temp7 = asRegister(xmm7Temp, I386Kind.DOUBLE);

        I386Address stackSlot = (I386Address) crb.asAddress(stackTemp);
        ...
        masm.shrl(gpr3, 12);
        masm.movdqu(dest, new I386Address(gpr4, gpr3, Scale.Times1, 0));
        masm.leaq(gpr4, externalAddress(coeffLogTwoDataPtr));
        masm.movdqu(temp4, new I386Address(gpr4, 16));                                       // 0x3d6fb175,
                                                                                              // 0xbfc5555e,
                                                                                              // 0x55555555,
                                                                                              // 0x3fd55555
        masm.addsd(temp1, temp5);
        masm.movdqu(temp2, new I386Address(gpr4, 32));                                       // 0x9999999a,
                                                                                              // 0x3fc99999,
                                                                                              // 0x00000000,
                                                                                              // 0xbfe00000
        ...
        masm.mulsd(temp7, new I386Address(gpr4, 8));                                         // 0x93c76730,
                                                                                              // 0x3ceef357
    ...
    public void log10Intrinsic(Register dest, Register value, CompilationResultBuilder crb, I386MacroAssembler masm) {
        ...
        masm.movdqu(temp4, new I386Address(gpr4, 16));                                       // 0x385593b1,
                                                                                              // 0xc025c917,
                                                                                              // 0xdc963467,
                                                                                              // 0x3ffc6a02
        masm.subsd(temp1, temp5);
        ...
        masm.mulsd(temp1, dest);
        masm.subsd(temp5, temp2);
        masm.movdqu(temp2, new I386Address(gpr4, 32));                                       // 0x7f9d3aa1,
                                                                                              // 0x4016ab9f,
                                                                                              // 0xdc77b115,
                                                                                              // 0xbff27af2
        ...
        masm.andl(gpr3, 16711680);
        masm.shrl(gpr3, 12);
        masm.movdqu(dest, new I386Address(gpr4, gpr3, Scale.Times1, -1504));
        masm.addsd(temp1, temp5);
        masm.mulsd(temp6, temp7);
        masm.pshufd(temp5, temp1, 0x44);
        masm.leaq(gpr4, externalAddress(logTwoLogTenDataPtr));
        masm.mulsd(temp7, new I386Address(gpr4, 8));                                         // 0x1f12b358,
                                                                                              // 0x3cdfef31
        masm.mulsd(temp3, temp1);
        masm.addsd(dest, temp6);
        masm.mulpd(temp4, temp5);
        masm.leaq(gpr4, externalAddress(logTenEPtr));
        masm.movdq(temp6, new I386Address(gpr4, 8));                                         // 0xbf2e4108,
                                                                                              // 0x3f5a7a6c
        masm.mulpd(temp5, temp5);
        masm.addpd(temp4, temp2);
        masm.mulpd(temp3, temp5);
    ...
    public void sinIntrinsic(Register dest, Register value, CompilationResultBuilder crb, I386MacroAssembler masm) {
        ...
        Register gpr3 = asRegister(rcxTemp, I386Kind.QWORD);
        Register gpr4 = asRegister(gpr4Temp, I386Kind.QWORD);
        Register gpr5 = asRegister(gpr5Temp, I386Kind.QWORD);
        Register gpr6 = asRegister(gpr6Temp, I386Kind.QWORD);
        Register gpr7 = asRegister(gpr7Temp, I386Kind.QWORD);
        Register gpr8 = asRegister(gpr8Temp, I386Kind.QWORD);
        Register gpr9 = asRegister(gpr9Temp, I386Kind.QWORD);
        Register gpr10 = asRegister(gpr10Temp, I386Kind.QWORD);
        ...
        Register temp6 = asRegister(xmm6Temp, I386Kind.DOUBLE);
        Register temp7 = asRegister(xmm7Temp, I386Kind.DOUBLE);
        Register temp8 = asRegister(xmm8Temp, I386Kind.DOUBLE);
        Register temp9 = asRegister(xmm9Temp, I386Kind.DOUBLE);
        ...
        masm.movl(gpr1, new I386Address(gpr1, 4));
        ...
        masm.addq(gpr1, gpr4);
        masm.movdqu(temp8, new I386Address(gpr1, 0));
        ...
        masm.movdq(temp3, new I386Address(gpr1, 24));
        ...
        masm.subsd(temp3, temp4);
        masm.addsd(temp1, new I386Address(gpr1, 16));
        ...
        masm.movl(gpr9, new I386Address(gpr3, 20));
        masm.movl(gpr7, new I386Address(gpr3, 24));
        masm.movl(gpr4, gpr1);
        masm.shrq(gpr1, 21);
        ...
        masm.movl(gpr5, new I386Address(gpr3, 16));
        masm.movl(gpr6, new I386Address(gpr3, 12));
        ...
        masm.movl(gpr8, new I386Address(gpr3, 8));
        masm.movl(gpr5, new I386Address(gpr3, 4));
        masm.movl(gpr2, gpr6);
        masm.shrq(gpr6, 32);
        masm.addq(gpr9, gpr2);
        masm.movl(gpr2, gpr9);
        ...
        masm.shlq(gpr9, 32);
        masm.orq(gpr9, gpr2);
        masm.movl(gpr1, new I386Address(gpr3, 0));
        ...
        masm.movdqu(temp2, new I386Address(gpr1, 0));                                        // 0x40000000,
                                                                                              // 0x3fe921fb,
                                                                                              // 0x18469899,
                                                                                              // 0x3e64442d
    ...
    public void cosIntrinsic(Register dest, Register value, CompilationResultBuilder crb, I386MacroAssembler masm) {
        ArrayDataPointerConstant oneHalfPtr = new ArrayDataPointerConstant(oneHalf, 16);
        ArrayDataPointerConstant pTwoPtr = new ArrayDataPointerConstant(pTwo, 16);
        ArrayDataPointerConstant scFourPtr = new ArrayDataPointerConstant(scFour, 16);
        ArrayDataPointerConstant cTablePtr = new ArrayDataPointerConstant(cTable, 16);
        ...
        masm.movdqu(temp2, new I386Address(gpr2, 0));                                      // 0x40000000,
                                                                                            // 0x3fe921fb,
                                                                                            // 0x18469899,
                                                                                            // 0x3e64442d
        masm.xorpd(temp5, temp5);
    ...
    public void tanIntrinsic(Register dest, Register value, CompilationResultBuilder crb, I386MacroAssembler masm) {
        ...
        masm.movdqu(temp7, new I386Address(gpr1, 16));
        masm.subsd(temp3, temp5);
        masm.mulpd(temp7, dest);
        masm.subpd(temp2, temp1);
        masm.movdqu(temp1, new I386Address(gpr1, 48));
        masm.mulpd(temp1, dest);
        masm.movdqu(temp4, new I386Address(gpr1, 96));
        masm.mulpd(temp4, dest);
        masm.addsd(temp2, temp3);
        masm.movdqu(temp3, dest);
        masm.mulpd(dest, dest);
        masm.addpd(temp7, new I386Address(gpr1, 0));
        masm.addpd(temp1, new I386Address(gpr1, 32));
        masm.mulpd(temp1, dest);
        masm.addpd(temp4, new I386Address(gpr1, 80));
        masm.addpd(temp7, temp1);
        masm.movdqu(temp1, new I386Address(gpr1, 112));
        masm.mulpd(temp1, dest);
        masm.mulpd(dest, dest);
        masm.addpd(temp4, temp1);
        masm.movdqu(temp1, new I386Address(gpr1, 64));
        masm.mulpd(temp1, dest);
        masm.addpd(temp7, temp1);
        masm.movdqu(temp1, temp3);
        masm.mulpd(temp3, dest);
        masm.mulsd(dest, dest);
        masm.mulpd(temp1, new I386Address(gpr1, 144));
        ...
        masm.movdq(temp7, new I386Address(gpr1, 144));
        masm.unpckhpd(temp2, temp2);
        masm.addsd(temp7, new I386Address(gpr1, 152));
        masm.mulsd(temp7, temp2);
        masm.addsd(temp7, new I386Address(gpr1, 136));
        masm.addsd(temp7, temp1);
        masm.addsd(dest, temp7);
        masm.movdq(temp7, externalAddress(onePtr));                                             // 0x00000000,
                                                                                                // 0x3ff00000
        masm.mulsd(temp4, temp6);
        masm.movdq(temp2, new I386Address(gpr1, 168));
        masm.andpd(temp2, temp6);
        masm.mulsd(temp5, temp2);
        masm.mulsd(temp6, new I386Address(gpr1, 160));
        masm.subsd(temp7, temp5);
        masm.subsd(temp2, new I386Address(gpr1, 128));
        ...
        masm.movdq(temp2, new I386Address(gpr1, 0));                                           // 0x00000000,
                                                                                                // 0x3fe921fb,
        masm.movdq(temp7, new I386Address(gpr1, 8));                                           // 0x4611a626,
                                                                                                // 0x3e85110b
        masm.xorpd(temp5, temp5);
        masm.subl(gpr4, 1008);
        masm.pinsrw(temp5, gpr4, 3);
    ...
    public void expIntrinsic(Register dest, Register value, CompilationResultBuilder crb, I386MacroAssembler masm) {
        ...
        Register temp8 = asRegister(xmm8Temp, I386Kind.DOUBLE);
        Register temp9 = asRegister(xmm9Temp, I386Kind.DOUBLE);
        Register temp10 = asRegister(xmm10Temp, I386Kind.DOUBLE);
        ...
        masm.movdqu(temp1, new I386Address(gpr2, 0));                                   // 0x652b82fe,
                                                                                         // 0x40571547,
                                                                                         // 0x652b82fe,
                                                                                         // 0x40571547
        masm.movdqu(temp6, externalAddress(shifterExpPtr));                              // 0x00000000,
                                                                                         ...
                                                                                         // 0x00000000,
                                                                                         // 0x43380000
        masm.movdqu(temp2, new I386Address(gpr2, 16));                                  // 0xfefa0000,
                                                                                         // 0x3f862e42,
                                                                                         // 0xfefa0000,
                                                                                         // 0x3f862e42
        masm.movdqu(temp3, new I386Address(gpr2, 32));                                  // 0xbc9e3b3a,
                                                                                         // 0x3d1cf79a,
                                                                                         // 0xbc9e3b3a,
                                                                                         // 0x3d1cf79a
        masm.pextrw(gpr1, dest, 3);
        ...
        masm.movdqu(temp8, new I386Address(gpr2, 48));                                  // 0xfffffffe,
                                                                                         // 0x3fdfffff,
                                                                                         // 0xfffffffe,
                                                                                         // 0x3fdfffff
        masm.movdqu(temp4, new I386Address(gpr2, 64));                                  // 0xe3289860,
                                                                                         // 0x3f56c15c,
                                                                                         // 0x555b9e25,
                                                                                         // 0x3fa55555
        masm.movdqu(temp5, new I386Address(gpr2, 80));                                  // 0xc090cf0f,
                                                                                         // 0x3f811115,
                                                                                         // 0x55548ba1,
                                                                                         // 0x3fc55555
        masm.mulpd(temp1, dest);
        ...
        masm.andl(gpr3, 63);
        masm.shll(gpr3, 4);
        masm.movdqu(temp2, new I386Address(gpr3, gpr4, Scale.Times1, 0));
        masm.sarl(gpr1, 6);
        masm.psllq(temp7, 46);
        masm.subpd(dest, temp3);
        masm.mulpd(temp4, dest);
        ...
        masm.movl(gpr1, new I386Address(gpr5, 4));
