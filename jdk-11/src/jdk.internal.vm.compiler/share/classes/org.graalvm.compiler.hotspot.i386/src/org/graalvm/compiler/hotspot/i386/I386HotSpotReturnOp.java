 ...
 */
@Opcode("RETURN")
final class I386HotSpotReturnOp extends I386HotSpotEpilogueBlockEndOp implements ZapStackArgumentSpaceBeforeInstruction {

    public static final LIRInstructionClass<I386HotSpotReturnOp> TYPE = LIRInstructionClass.create(I386HotSpotReturnOp.class);
    ...
    I386HotSpotReturnOp(Value value, boolean isStub, Register thread, Register scratchForSafepointOnReturn, GraalHotSpotVMConfig config) {
        super(TYPE);
        this.value = value;
        this.isStub = isStub;
        this.thread = thread;
    ...
    public void emitCode(CompilationResultBuilder crb, I386MacroAssembler masm) {
        ...
        if (!isStub) {
            ...
            I386HotSpotSafepointOp.emitCode(crb, masm, config, true, null, thread, scratchForSafepointOnReturn);
