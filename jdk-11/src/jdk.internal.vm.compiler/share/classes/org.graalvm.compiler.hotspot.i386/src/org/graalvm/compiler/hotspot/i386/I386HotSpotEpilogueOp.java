 ...
 */
abstract class I386HotSpotEpilogueOp extends I386LIRInstruction implements I386HotSpotRestoreRbpOp {

    protected I386HotSpotEpilogueOp(LIRInstructionClass<? extends I386HotSpotEpilogueOp> c) {
        super(c);
    }
    ...
    static void leaveFrameAndRestoreRbp(AllocatableValue savedRbp, CompilationResultBuilder crb, I386MacroAssembler masm) {
        if (isStackSlot(savedRbp)) {
            // Restoring RBP from the stack must be done before the frame is removed
            masm.movq(rbp, (I386Address) crb.asAddress(savedRbp));
        } else {
