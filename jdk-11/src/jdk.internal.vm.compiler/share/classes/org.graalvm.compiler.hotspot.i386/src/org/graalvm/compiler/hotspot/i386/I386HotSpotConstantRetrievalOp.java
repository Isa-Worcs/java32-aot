...
public final class I386HotSpotConstantRetrievalOp extends I386LIRInstruction {
    public static final LIRInstructionClass<I386HotSpotConstantRetrievalOp> TYPE = LIRInstructionClass.create(I386HotSpotConstantRetrievalOp.class);
    ...
    public I386HotSpotConstantRetrievalOp(Constant[] constants, AllocatableValue[] constantDescriptions, LIRFrameState frameState, ForeignCallLinkage callLinkage, Object[] notes) {
        super(TYPE);
