...
final class I386HotSpotStrategySwitchOp extends I386ControlFlow.StrategySwitchOp {
    public static final LIRInstructionClass<I386HotSpotStrategySwitchOp> TYPE = LIRInstructionClass.create(I386HotSpotStrategySwitchOp.class);

    I386HotSpotStrategySwitchOp(SwitchStrategy strategy, LabelRef[] keyTargets, LabelRef defaultTarget, Value key, Value scratch) {
    ...
    public class HotSpotSwitchClosure extends SwitchClosure {
        ...
        protected HotSpotSwitchClosure(Register keyRegister, CompilationResultBuilder crb, I386MacroAssembler masm) {
        ...
        protected void emitComparison(Constant c) {
            if (c instanceof HotSpotMetaspaceConstant) {
                ...
                if (meta.isCompressed()) {
                    ...
                    I386Address addr = (I386Address) crb.recordDataReferenceInCode(meta, 8);
