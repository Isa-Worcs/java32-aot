 ...
 */
@Opcode("CALL_DIRECT")
final class I386HotSpotDirectStaticCallOp extends DirectCallOp {
    public static final LIRInstructionClass<I386HotSpotDirectStaticCallOp> TYPE = LIRInstructionClass.create(I386HotSpotDirectStaticCallOp.class);

    private final InvokeKind invokeKind;
    private final GraalHotSpotVMConfig config;

    I386HotSpotDirectStaticCallOp(ResolvedJavaMethod target, Value result, Value[] parameters, Value[] temps, LIRFrameState state, InvokeKind invokeKind, GraalHotSpotVMConfig config) {
