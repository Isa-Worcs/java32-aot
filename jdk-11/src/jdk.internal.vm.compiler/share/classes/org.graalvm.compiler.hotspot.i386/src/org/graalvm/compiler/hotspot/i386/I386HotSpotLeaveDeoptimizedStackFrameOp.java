...
final class I386HotSpotLeaveDeoptimizedStackFrameOp extends I386HotSpotEpilogueOp {

    public static final LIRInstructionClass<I386HotSpotLeaveDeoptimizedStackFrameOp> TYPE = LIRInstructionClass.create(I386HotSpotLeaveDeoptimizedStackFrameOp.class);
    @Use(REG) AllocatableValue frameSize;
    @Use(REG) AllocatableValue framePointer;

    I386HotSpotLeaveDeoptimizedStackFrameOp(AllocatableValue frameSize, AllocatableValue initialInfo) {
        super(TYPE);
