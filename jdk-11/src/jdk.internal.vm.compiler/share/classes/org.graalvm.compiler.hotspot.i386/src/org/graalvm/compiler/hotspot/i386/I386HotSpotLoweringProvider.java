...
import static org.graalvm.compiler.hotspot.i386.I386HotSpotForeignCallsProvider.ARITHMETIC_COS_STUB;
import static org.graalvm.compiler.hotspot.i386.I386HotSpotForeignCallsProvider.ARITHMETIC_EXP_STUB;
import static org.graalvm.compiler.hotspot.i386.I386HotSpotForeignCallsProvider.ARITHMETIC_LOG10_STUB;
import static org.graalvm.compiler.hotspot.i386.I386HotSpotForeignCallsProvider.ARITHMETIC_LOG_STUB;
import static org.graalvm.compiler.hotspot.i386.I386HotSpotForeignCallsProvider.ARITHMETIC_POW_STUB;
import static org.graalvm.compiler.hotspot.i386.I386HotSpotForeignCallsProvider.ARITHMETIC_SIN_STUB;
import static org.graalvm.compiler.hotspot.i386.I386HotSpotForeignCallsProvider.ARITHMETIC_TAN_STUB;
...
import org.graalvm.compiler.replacements.i386.I386ConvertSnippets;
...
public class I386HotSpotLoweringProvider extends DefaultHotSpotLoweringProvider {

    private I386ConvertSnippets.Templates convertSnippets;
    ...
    public void initialize(OptionValues options, Iterable<DebugHandlersFactory> factories, HotSpotProviders providers, GraalHotSpotVMConfig config) {
        convertSnippets = new I386ConvertSnippets.Templates(options, factories, providers, providers.getSnippetReflection(), providers.getCodeCache().getTarget());
