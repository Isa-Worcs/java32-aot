...
final class I386HotSpotJumpToExceptionHandlerInCallerOp extends I386HotSpotEpilogueBlockEndOp {

    public static final LIRInstructionClass<I386HotSpotJumpToExceptionHandlerInCallerOp> TYPE = LIRInstructionClass.create(I386HotSpotJumpToExceptionHandlerInCallerOp.class);
    ...
    I386HotSpotJumpToExceptionHandlerInCallerOp(AllocatableValue handlerInCallerPc, AllocatableValue exception, AllocatableValue exceptionPc, int isMethodHandleReturnOffset, Register thread) {
        super(TYPE);
    ...
    public void emitCode(CompilationResultBuilder crb, I386MacroAssembler masm) {
        ...
        if (GraalServices.JAVA_SPECIFICATION_VERSION < 8) {
            ...
            I386Address dst = new I386Address(thread, isMethodHandleReturnOffset);
            masm.cmpl(dst, 0);
