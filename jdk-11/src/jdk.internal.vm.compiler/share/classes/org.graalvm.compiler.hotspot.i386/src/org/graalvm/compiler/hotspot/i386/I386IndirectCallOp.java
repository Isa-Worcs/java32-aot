...
import org.graalvm.compiler.lir.i386.I386Call.IndirectCallOp;
...
final class I386IndirectCallOp extends IndirectCallOp {
    public static final LIRInstructionClass<I386IndirectCallOp> TYPE = LIRInstructionClass.create(I386IndirectCallOp.class);

    /**
     * Vtable stubs expect the metaspace Method in RBX.
     */
    public static final Register METHOD = I386.rbx;

    @Use({REG}) protected Value metaspaceMethod;

    private final GraalHotSpotVMConfig config;

    I386IndirectCallOp(ResolvedJavaMethod targetMethod, Value result, Value[] parameters, Value[] temps, Value metaspaceMethod, Value targetAddress, LIRFrameState state,
    ...
    public void emitCode(CompilationResultBuilder crb, I386MacroAssembler masm) {
        ...
        int pcOffset = I386Call.indirectCall(crb, masm, callReg, callTarget, state);
