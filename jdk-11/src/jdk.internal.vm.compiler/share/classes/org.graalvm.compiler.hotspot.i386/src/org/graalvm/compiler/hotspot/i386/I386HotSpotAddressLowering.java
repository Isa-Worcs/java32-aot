...
import org.graalvm.compiler.core.i386.I386AddressNode;
...
public class I386HotSpotAddressLowering extends I386CompressAddressLowering {
    ...
    @Override
    protected final boolean improveUncompression(I386AddressNode addr, CompressionNode compression, ValueNode other) {
    ...
    public void postProcess(AddressNode lowered) {
        ...
        // the backend.
        I386AddressNode address = (I386AddressNode) lowered;
