...
public class I386AddressLowering extends AddressLowering {
    ...
    public AddressNode lower(ValueNode base, ValueNode offset) {
        I386AddressNode ret = new I386AddressNode(base, offset);
    ...
    /**
     * Tries to optimize addresses so that they match the I386-specific addressing mode better
     ...
     */
    protected boolean improve(StructuredGraph graph, DebugContext debug, I386AddressNode ret, boolean isBaseNegated, boolean isIndexNegated) {
    ...
    private boolean improveNegation(StructuredGraph graph, DebugContext debug, I386AddressNode ret, boolean originalBaseNegated, boolean originalIndexNegated) {
    ...
    private static ValueNode improveInput(I386AddressNode address, ValueNode node, int shift, boolean negateExtractedDisplacement) {
        if (node == null) {
            return null;
        }
    ...
    private static ValueNode improveConstDisp(I386AddressNode address, ValueNode original, JavaConstant c, ValueNode other, int shift, boolean negateExtractedDisplacement) {
    ...
    protected static boolean updateDisplacement(I386AddressNode address, long displacementDelta, boolean negateDelta) {
