...
import org.graalvm.compiler.lir.i386.I386Move.I386PushPopStackMove;
...
public abstract class I386MoveFactoryBase implements MoveFactory {
    ...
    public I386MoveFactoryBase(BackupSlotProvider backupSlotProvider) {
        this.backupSlotProvider = backupSlotProvider;
    }

    @Override
    public final I386LIRInstruction createStackMove(AllocatableValue result, AllocatableValue input) {
        I386Kind kind = (I386Kind) result.getPlatformKind();
        switch (kind.getSizeInBytes()) {
            case 2:
                return new I386PushPopStackMove(WORD, result, input);
            case 8:
                return new I386PushPopStackMove(QWORD, result, input);
            default:
    ...
    public abstract I386LIRInstruction createStackMove(AllocatableValue result, AllocatableValue input, Register scratchRegister, AllocatableValue backupSlot);
}
