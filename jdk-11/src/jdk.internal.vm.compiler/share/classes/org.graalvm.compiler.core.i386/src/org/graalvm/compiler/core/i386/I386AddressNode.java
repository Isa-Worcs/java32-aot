 ...
 */
@NodeInfo
public class I386AddressNode extends AddressNode implements Simplifiable, LIRLowerable {

    public static final NodeClass<I386AddressNode> TYPE = NodeClass.create(I386AddressNode.class);
    ...
    public I386AddressNode(ValueNode base) {
        this(base, null);
    }

    public I386AddressNode(ValueNode base, ValueNode index) {
        super(TYPE);
        this.base = base;
        this.index = index;
    ...
    public void generate(NodeLIRBuilderTool gen) {
        ...
        gen.setResult(this, new I386AddressValue(kind, baseValue, indexValue, scale, displacement));
    }
